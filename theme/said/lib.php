...
function theme_said_get_main_scss_content($theme) {
    global $CFG;
    ...
    $pre = file_get_contents($CFG->dirroot . '/theme/said/scss/pre.scss');
    // Post CSS - this is loaded AFTER the main scss but before the extra scss from the setting.
    $post = file_get_contents($CFG->dirroot . '/theme/said/scss/post.scss');
